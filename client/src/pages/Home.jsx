        ...
        <section style={{ 
          ...
          <div className="animate-fade-in" style={{ 
            ...
            <div style={{ display: 'flex', padding: '2rem', gap: '2rem' }}>
              {/* Fake Sidebar */}
              <div className="flex-desktop-only" style={{ width: '200px', flexDirection: 'column', gap: '1rem' }}>
              ...
              {/* Fake Content */}
              <div style={{ flex: 1 }}>
                <div className="mockup-row" style={{ display: 'flex', gap: '1rem', marginBottom: '2rem' }}>
                ...
                <div className="mockup-row" style={{ display: 'flex', gap: '1rem' }}>
